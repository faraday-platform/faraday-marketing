    ...
    <main>
      ...
      <section id="platform" className="relative z-[1] py-24 px-6 sm:px-10 border-t border-border">
        <div className="max-w-[900px] mx-auto">
          ...
          <p className="font-mono text-[12px] text-subtle tracking-[0.08em] uppercase mb-4">
            For technical teams evaluating the platform:
          </p>

          <div className="bg-card border border-border-hover rounded-[20px] p-8 sm:p-12 text-left mb-8">
